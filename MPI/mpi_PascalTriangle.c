...
void compute_rows(long int start,long int end){
   long int i,blk,j,c=1;
   for(i=start;i<end;i++)
     {
        for(blk=1;blk<=end-i;blk++) printf("  ");
        for(j=0;j<=i;j++)
          {
            if (j==0||i==0)
                c=1;
   ...
   if(id_proceso==master){
        ...
        switch(id_proceso){
             case worker_1:
                 ...
                 compute_rows(to_worker_1[0],to_worker_1[1]);
                 from_worker_1=1;
             ...
             case worker_2:
                 ...
                 compute_rows(to_worker_2[0],to_worker_2[1]);
                 from_worker_2=1;
             ...
             case worker_3:
                 ...
                 compute_rows(to_worker_3[0],to_worker_3[1]);
                 from_worker_3=1;
